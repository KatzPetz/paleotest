...
-- Dunkleosteus Egg by ElCeejo

mobs:register_mob("paleotest:Dunkleosteus_egg", {
	type = "nil",
	hp_min = 5,
	hp_max = 5,
	armor = 200,
	...
	do_custom = function(self, dtime)
		...
		mob = minetest.add_entity(pos, "paleotest:dunkleosteus")
...
mobs:register_egg("paleotest:Dunkleosteus_egg", S("Dunkleosteus Egg"), "paleotest_egg1_inv.png", 0)
